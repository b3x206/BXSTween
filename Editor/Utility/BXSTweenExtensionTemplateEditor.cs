...
// Please refer to ./BXSTweenExtensionTemplateEditor.cs in the same directory.
namespace BX.Tweening
{
    ...
    public class BXSTweenExtensionTemplateEditor : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            {
                height += NonUniqueValuesWarningBoxHeight + mainCtx.YMargin;
            }
            ...
            for (int i = 0; i < currentArrayProperty.arraySize && childListExpanded; i++)
            {
                ...
                height += EditorGUI.GetPropertyHeight(methodNameProperty) + mainCtx.YMargin;
