...
namespace BX.Tweening
{
    ...
    /// <br>While this class is editable in the unity editor, you cannot add sequences to it. Only change the delay length and loop count.</br>
    /// </summary>
    /// TODO : Reimplement this to be better.
    ///        Current state is "hacky" as it dispatches tween and yields that 
    ///        instead of simulating the target tween, while this sequence is ticked.
    ///        ---
    ///        And it doesn't even do that right. This is basically spaghetti, unlike the other classes.
    ///        ---
    ...
    public sealed class BXSTweenSequence : BXSTweenable, ICollection<BXSTweenable>, IEnumerable<KeyValuePair<int, BXSTweenable>>
    {
        ...
        /// </summary>
        public sealed class RunnableTween : IEquatable<RunnableTween>, IComparable<RunnableTween>
        {
            public int priority;
        ...
        private List<RunnableTween> m_RunnableTweens = new List<RunnableTween>();
        ...
        public override void ResetPreserveLoop()
        {
        ...
        /// <summary>
        /// Is usually false if the backing collection is suitable to be written in this context.
        /// </summary>
        ...
        /// <summary>
        /// Adds a tween to the first sequence priority.
        ...
        // Without this, the whole Sequence stutters. (meaning that PriorityDuration is a hotpath because of BXSTweenable.Duration) getter
        // This _shows_ that yes, Sequence is poorly designed, but some effort was required to not use predicate chaining.
        // A yielding coroutine would maybe have done this better.. Technically we would only have to check the relevant tween.
        // --
        ...
        /// </summary>
        public BXSTweenSequence SetPlayAction(BXSAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
            switch (setMode)
            {
        ...
        /// </summary>
        public BXSTweenSequence SetStartAction(BXSAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
            switch (setMode)
            {
                case ValueSetMode.Remove:
        ...
        /// </summary>
        public BXSTweenSequence SetTickAction(BXSAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
            switch (setMode)
            {
                case ValueSetMode.Remove:
        ...
        /// </summary>
        public BXSTweenSequence SetUpdateAction(BXSAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
        ...
        /// </summary>
        public BXSTweenSequence SetPauseAction(BXSAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
            switch (setMode)
            {
                case ValueSetMode.Remove:
        ...
        /// </summary>
        public BXSTweenSequence SetRepeatAction(BXSAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
            switch (setMode)
            {
                case ValueSetMode.Remove:
        ...
        /// </summary>
        public BXSTweenSequence SetEndAction(BXSAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
            switch (setMode)
            {
                case ValueSetMode.Remove:
        ...
        /// <br>This does not set any of the added Tweenables actions.</br>
        /// </summary>
        public BXSTweenSequence SetStopAction(BXSAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
            switch (setMode)
            {
                case ValueSetMode.Remove:
        ...
        /// </summary> 
        public BXSTweenSequence SetTickConditionAction(BXSTickConditionAction action, ValueSetMode setMode = ValueSetMode.Equals)
        {
            switch (setMode)
            {
                case ValueSetMode.Remove:
